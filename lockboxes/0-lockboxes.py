...
def canUnlockAll(boxes):
    ...
    Args:
        boxes (list): A list of lists representing the boxes and their corresponding keys. Each inner list contains the indices of the boxes that can be opened with the key.
